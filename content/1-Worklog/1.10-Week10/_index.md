...
**Objective:** Automatically adjust the number of servers based on actual user demand.
...
**Result:** Successfully built an architecture capable of elastic scaling, optimizing both performance and cost.
